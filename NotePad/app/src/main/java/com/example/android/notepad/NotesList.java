...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getFormatedDateTime("yyyy-MM-dd HH:mm:ss",Long.getLong(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE));

        //timeStamp2Date(Long.getLong(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE),null);
        ...
        //搜索按钮响应
//
//        final View view1 = View.inflate(this,R.layout.search_item,null);
//
//        final Button button=view1.findViewById(R.id.button2);
//
//        final EditText text=(EditText)view1.findViewById(R.id.editText);
//
//        final String meat=text.getText().toString();
//
//        if(button!=null){
//            Log.d("TestApp",button.getText().toString());
//            button.setText("awgawef");
//
//
//        }
//
...
//                Log.d(TestApp,text.getText().toString());
//
//
